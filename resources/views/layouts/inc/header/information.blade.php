...
<header class="w-full bg-[#ffffffcc] fixed top-0 z-100 transition ease-in">
    <div class="container flex justify-between items-center mx-auto py-3 px-4">
        ...
        <div class="links flex items-center">
                ...
                <div class="nav-link relative group mr-4">
                    ...
                    <div
                        ...
                        <div class="sub-nav-links flex flex-col w-1/2 px-2 border-r border-[#eee] xl:px-4">
                            ...
                            <a href="{{ route('information.production.products.aluminum') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Алюминиевые двери и витражи</a>
                            <a href="{{ route('information.production.products.parts') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Комплектующие</a>
                            <a href="{{ route('information.production.products.solution') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Нестандартные решения</a>
                            <a href="{{ route('information.production.products.glazing') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Остекления и перегородки</a>
                            <a href="{{ route('information.production.products.plastic') }}" class="text-sm transition hover:text-[#0a49bf]">Пластиковые окна и двери</a>
                        </div>
                        ...
                        <div class="sub-nav-links flex flex-col w-1/2 px-2 xl:px-4">
                            ...
                            <a href="{{ route('information.production.service.advices') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Рекомендации по уходу</a>
                            <a href="{{ route('information.production.service.security') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Гарантии</a>
                            <a href="{{ route('information.production.service.montage') }}" class="text-sm mb-1 transition hover:text-[#0a49bf]">Монтаж</a>
                        </div>
                    </div>
                </div>

                <div class="nav-link relative group mr-4">
                    <a href="{{ route('information.dealers') }}"
                       class="link group flex items-center transition hover:text-[#0a49bf]">Дилерам</a>
                </div>

                <div class="nav-link relative group mr-4">
                    <a href="{{ route('information.vacancies') }}"
                       class="link group flex items-center transition hover:text-[#0a49bf]">Вакансии</a>
                </div>

                <div class="nav-link relative group">
                    <a href="{{ route('information.about') }}"
                       class="link group flex items-center transition hover:text-[#0a49bf]">
                        О компании
                    ...
                    <div class="sub-nav flex flex-col absolute invisible opacity-0 top-10 -left-5 xl:-left-10 bg-white border py-1 px-2 xl:py-2 xl:px-3 border-[#e6eaf0] rounded-2xl transition duration-300 before:content-[] before:absolute before:w-full before:h-5 before:bg-transparent before:-top-5 group-hover:visible group-hover:opacity-100">
                        <a href="{{ route('information.about.projects') }}" class="flex items-center transition hover:text-[#0a49bf] text-sm xl:text-base">
                        ...
                        <a href="{{ route('information.about.certificates') }}" class="flex items-center transition hover:text-[#0a49bf] text-sm xl:text-base">
                            <svg class="w-4 h-4 xl:w-5 xl:h-5 mr-1">
                        ...
                        <a href="{{ route('information.about.partners') }}"
                        ...
                        <a href="{{ route('information.about.contacts') }}"
                           class="flex items-center transition hover:text-[#0a49bf] text-sm xl:text-base">
                            <svg class="w-4 h-4 xl:w-5 xl:h-5 mr-1">
            ...
            <div class="auth">
                @if(!Auth::check())
                    <a href="{{ route('system.auth.loginView') }}" class="bg-[#0a49bf] text-white px-4 py-2 rounded-lg transition hover:bg-blue-600 active:text-black lg:px-7 lg:py-3 lg:rounded-2xl">Войти</a>
                @else
